...
const translations = {
  en: {
    ...
    dashboard: { title: 'Dashboard', totalMachines: 'Total Machines', todayProduction: 'Today Production', defectRate: 'Defect Rate', oee: 'OEE', overview: 'Overview' },
    status: { running: 'Running', idle: 'Idle', maintenance: 'Maintenance', broken: 'Broken' },
    reports: { export: 'Export', productionReport: 'Production Report' },
  },
  ar: {
    add: 'إضافة',
    edit: 'تعديل',
    ...
    dashboard: { title: 'لوحة التحكم', totalMachines: 'إجمالي الآلات', todayProduction: 'إنتاج اليوم', defectRate: 'معدل العيوب', oee: 'الكفاءة الكلية', overview: 'نظرة عامة' },
    status: { running: 'قيد التشغيل', idle: 'خامل', maintenance: 'صيانة', broken: 'معطل' },
    reports: { export: 'تصدير', productionReport: 'تقرير الإنتاج' },
  }
};
